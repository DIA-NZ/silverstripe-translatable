...
class Translatable extends SilverStripe\ORM\DataExtension implements SilverStripe\Security\PermissionProvider
{
 ...
 * @subpackage misc
 */
class Translatable_Transformation extends SilverStripe\Forms\FormTransformation
{
    /**
     * @var DataObject
     */
